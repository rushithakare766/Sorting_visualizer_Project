...
speedScale = Scale(UI_Frame, from_=0.2, to=0.0, length=200, digits=2, resolution=0.0, orient=HORIZONTAL, label='Select Speed [sec]', font=('Courier', 12))
speedScale.place(relx=0.5, rely=0, relheight=0.47, relwidth=0.35)

# Start Button
startB = Button(UI_Frame, text="Start", command=startAlgorithm, bg='#00a915', font=('Courier', 10))
startB.place(relx=0.87, rely=0.1, relwidth=0.13, relheight=0.3)

# Menu Row[2] (Entry Scales)
sizeEntry = Scale(UI_Frame, from_=10, to=150, resolution=1, orient=HORIZONTAL, label='Data Size', font=('Courier', 12))
sizeEntry.place(relx=0, rely=0.53, relheight=0.47, relwidth=0.25)

minEntry = Scale(UI_Frame, from_=0, to=10, resolution=1, orient=HORIZONTAL, label='Min Value', font=('Courier', 12))
minEntry.place(relx=0.30, rely=0.53, relheight=0.47, relwidth=0.25)

maxEntry = Scale(UI_Frame, from_=10, to=100, resolution=1, orient=HORIZONTAL, label='Max Value', font=('Courier', 12))
maxEntry.place(relx=0.6, rely=0.53, relheight=0.47, relwidth=0.25)

# Generate Button
genB = Button(UI_Frame, text="Generate", command=generate, bg='#2b3636', fg='white', font=('Courier', 10))
genB.place(relx=0.87, rely=0.6, relwidth=0.13, relheight=0.3)

mainFrame = Canvas(root, bg='#b1aeae')
